  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col items-start">
        ...
        <h3 className="text-[1.5rem] font-bold leading-[1.1] tracking-[-0.02em] tabular-nums text-[color:var(--text-primary)]">{value}</h3>
        {trend && (
      ...
      <div className="w-[28px] h-[28px] rounded-[var(--radius-sm)] shrink-0 flex items-center justify-center bg-[var(--accent)] text-[color:var(--accent-contrast)] shadow-[0_2px_10px_rgba(189,149,47,0.35)]">
